...
const SCREENSHOTMAC ='SCREENSHOTMAC'
const SCREENSHOTWINDOWS = 'SCREENSHOTWINDOWS'
const GETDEVICETOKEN = 'GETDEVICETOKEN'
const GET_FILE_PATH = 'GET_FILE_PATH'
const CHOOSE_FILE_CALLBACK = 'CHOOSE_FILE_CALLBACK'

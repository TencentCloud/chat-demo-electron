...
const GroupSysElm = (props: any): JSX.Element => {
    ...
    const opType = ["","有人申请加群","申请加群被同意","申请加群被拒绝","被管理员踢出群","群被解散","创建群","您被邀请加群","主动退群","被设置管理员","被取消管理员","群已被回收","邀请加群","邀请加群被同意","邀请加群被拒绝","已读上报多终端同步通知","用户自定义通知","已被禁言","话题被创建","话题被删除","群消息已读","群消息接收项变更","被封禁","邀请入群请求需审批"]
    const getOpUser = () => {
